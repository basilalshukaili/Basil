          ...
          "skills": [
            {
              "id": "2.1.1",
              "name": "CIA Triad",
              "description": "The three core principles of information security: Confidentiality, Integrity, and Availability.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": []
            },
            {
              ...
              "description": "Understanding the difference between authentication (verifying identity) and authorization (granting access rights).",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.1.1"]
            },
            {
              ...
              "description": "Understanding different types of security controls: administrative, technical, and physical.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.1.1"]
            },
            {
              ...
              "description": "The concept of layering security controls to provide redundancy in case one control fails.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.1.3"]
            },
            {
              ...
              "description": "The principle of providing only the minimum necessary access rights for users to perform their job functions.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.1.2"]
          ...
          "skills": [
            {
              "id": "2.2.1",
              "name": "Threat Actors",
              "description": "Understanding different types of threat actors, their motivations, and capabilities.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": []
            },
            {
              "id": "2.2.2",
              "name": "Attack Vectors",
              "description": "Common paths or means by which an attacker can gain access to a computer or network server.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.2.1"]
            },
            {
              ...
              "description": "Understanding common security vulnerabilities and how they can be exploited.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.2.2"]
            },
            {
              ...
              "description": "Understanding the stages of a cyber attack, from reconnaissance to exfiltration.",
              "progress": 0,
              "completed": false,
              "completedOn": null,
              "prerequisites": ["2.2.2", "2.2.3"]
            }
          ]
        }
      ]
